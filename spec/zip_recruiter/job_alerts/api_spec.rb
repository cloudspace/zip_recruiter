...
describe ZipRecruiter::JobAlerts::API do
  ...
  describe "#subscribe" do
    it "calls perform_action with the correct argument" do
  ...
  describe "#unsubscribe" do
    it "calls perform_action on unsubscribe with the correct argument" do
  ...
  describe "#status" do
    it "calls perform_action on status with the correct argument" do
